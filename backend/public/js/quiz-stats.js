      ...
      db.collection('quiz_metrics')
        ...
        .catch(err => {
          ...
          if (err.code === 'failed-precondition' || err.message.includes('index')) {
            ...
            document.getElementById('stats-content').innerHTML = `
              <div class="bg-red-900/30 backdrop-blur-sm rounded-xl shadow-xl border border-red-700 p-8">
                <div class="text-center mb-6">
                  ...
                  <p class="text-gray-300 mb-4">A database index needs to be created to enable statistics.</p>
                </div>
                
                ${indexUrl ? `
                  <div class="bg-blue-900/30 border border-blue-700 rounded-lg p-4 mb-4">
                    <p class="text-sm text-gray-300 mb-3 font-semibold">👉 Click the button below to create the index:</p>
                    <a href="${indexUrl}" target="_blank" class="block w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded-lg transition text-center">
                ...
                <div class="bg-gray-800/50 p-4 rounded-lg mb-4">
                  <p class="text-sm text-gray-400 mb-2 font-semibold">Steps:</p>
                  <ol class="text-sm text-gray-300 space-y-2 list-decimal list-inside">
                    <li>Click the blue button above to open Firebase Console</li>
                    <li>Click the <strong>"Create Index"</strong> button</li>
                    <li>Wait 2-5 minutes for index creation</li>
                    <li>Come back and click "Refresh Page" below</li>
                  </ol>
                </div>
                
                <div class="text-center">
                  <button onclick="location.reload()" class="bg-emerald-600 hover:bg-emerald-700 text-white font-bold px-6 py-3 rounded-lg transition">
                    🔄 Refresh Page
                  </button>
                </div>
              </div>
            ...
            document.getElementById('stats-content').innerHTML = `
              <div class="bg-red-900/30 backdrop-blur-sm rounded-xl shadow-xl border border-red-700 p-8 text-center">
                ...
                <p class="text-gray-300 mb-4">${err.message}</p>
                <button onclick="location.reload()" class="bg-blue-600 hover:bg-blue-700 px-6 py-2 rounded-lg transition">Retry</button>
              </div>
            `;
          }
        });
